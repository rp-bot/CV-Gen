...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(40, 490, 711, 103))
        ...
        self.skills.addWidget(self.toolbtn_skills, 1, 1, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.tbl_skills = QtWidgets.QTableWidget(self.gridLayoutWidget_2)
        self.tbl_skills.setGridStyle(QtCore.Qt.SolidLine)
        self.tbl_skills.setRowCount(10)
        ...
        self.skills.addWidget(self.tbl_skills, 1, 0, 1, 1)
        self.lbl_skills = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.lbl_skills.setObjectName("lbl_skills")
        self.skills.addWidget(self.lbl_skills, 0, 0, 1, 1)
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(40, 630, 711, 103))
        ...
        self.courses.addWidget(self.toolbtn_courses, 1, 1, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        self.tbl_courses.setRowCount(10)
        ...
        self.courses.addWidget(self.tbl_courses, 1, 0, 1, 1)
        self.lbl_courses = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.lbl_courses.setObjectName("lbl_courses")
        self.courses.addWidget(self.lbl_courses, 0, 0, 1, 1)
        self.gridLayoutWidget_4 = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(40, 770, 711, 103))
        ...
        self.education.addWidget(self.tbl_edu, 1, 0, 1, 1)
        ...
        self.education.addWidget(self.toolbtn_edu, 1, 1, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.lbl_edu = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.lbl_edu.setObjectName("lbl_edu")
        self.education.addWidget(self.lbl_edu, 0, 0, 1, 1)
        self.gridLayoutWidget_5 = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(40, 910, 711, 103))
        ...
        self.job_history.addWidget(self.toolbtn_jobs, 1, 1, 1, 1, QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        ...
        self.job_history.addWidget(self.tbl_jobs, 1, 0, 1, 1)
        self.lbl_jobs = QtWidgets.QLabel(self.gridLayoutWidget_5)
        self.lbl_jobs.setObjectName("lbl_jobs")
        self.job_history.addWidget(self.lbl_jobs, 0, 0, 1, 1)
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(40, 240, 681, 211))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.Introduction = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.Introduction.setContentsMargins(0, 0, 0, 0)
        self.Introduction.setObjectName("Introduction")
        self.lbl_intro = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.lbl_intro.setObjectName("lbl_intro")
        self.Introduction.addWidget(self.lbl_intro)
        self.txt_intro = QtWidgets.QTextEdit(self.verticalLayoutWidget)
        self.txt_intro.setObjectName("txt_intro")
        self.Introduction.addWidget(self.txt_intro)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_skills.setText(_translate("MainWindow", "Strengths & Skills"))
        ...
        self.lbl_courses.setText(_translate("MainWindow", "Relevant Courses"))
        ...
        self.lbl_edu.setText(_translate("MainWindow", "Education"))
        ...
        self.lbl_jobs.setText(_translate("MainWindow", "Job History"))
        self.lbl_intro.setText(_translate("MainWindow", "Introduction"))
        self.txt_intro.setPlaceholderText(_translate("MainWindow", "I am Computer Science Major willing to work hard and learn..."))
